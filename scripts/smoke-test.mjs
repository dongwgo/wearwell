...
const expression = `
  ...
  return ({
    ...
    // 코튼·폴리에스테르는 거의 모든 옷에서 나와 이름만 길게 만든다. 이름에 들어가면 안 된다.
    genericMaterialDropped: garmentFeatureName({ category: '하의', analysis: { primaryColor: '블랙', pattern: '무지', length: '롱', fit: '레귤러', material: '폴리에스테르', subcategory: '슬랙스' } }),
    // 기장 '반바지'와 품목 '쇼츠'는 같은 말이라 한 번만 적혀야 한다.
    synonymCollapsed: garmentFeatureName({ category: '하의', analysis: { primaryColor: '카키', pattern: '무지', length: '반바지', fit: '레귤러', material: '코튼', subcategory: '쇼츠' } }),
    renamedFromFeatures: (() => {
