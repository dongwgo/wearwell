    ...
    def generate_avatar(self, data: Measurements) -> tuple[Image.Image, str]:
        ...
        if has_cuda and os.getenv("ONEULOUT_GPU", "1") == "1":
            prompt = (
                ...
                "arms slightly away from the torso. Compose a wide full-length catalog shot that shows the entire "
                "person from the top of the hair through both ankles to the soles of both feet. Dress both feet in "
                "plain charcoal low-top studio shoes. Both complete shoes and the floor beneath them must be visible. "
                "Leave generous empty margin above the head, below the shoes, and on both sides. The person must occupy "
                "no more than 75 percent of the image height. Position the eye-level camera far enough away to capture "
                "the complete body with an 85 mm catalog lens. Do not crop the head, hands, legs, ankles, feet, or shoes. "
